...
description: "Summarize authored commits over a user-specified time period into a concise update. Use for \"what did I get done\", \"summarize my week\", or a standup update."
---

# What did I get done

_Source: [Cursor team kit](https://github.com/cursor/plugins/tree/main/cursor-team-kit/skills/what-did-i-get-done), MIT license._
