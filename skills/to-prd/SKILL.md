...
Loop mode: in `bram-maintainer-loop-v2`, draft the PRD to clarify broad work before implementation. Publish to GitHub only when issue creation is authorized.
