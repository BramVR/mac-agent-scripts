...
5. **Search author-specific spaces only with explicit user authorization.** If the PR author has a personal notebook (common at some companies), it may hold exploratory thinking that preceded the code.
...
Return only the minimum relevant excerpt. Redact secrets, personal data, customer information, and unrelated confidential content before quoting it.
