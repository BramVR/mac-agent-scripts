...
Before spawning investigators, list the available MCPs from the Codex environment. Use the available-tools map when present. Otherwise inspect the MCP servers Codex has configured.
