---
name: fix-ci
description: "Find failing PR checks, inspect logs or external check links, and apply focused fixes. Use for \"fix CI\", \"why is CI red\", or failing checks on a PR."
---

# Fix CI

_Source: [Cursor team kit](https://github.com/cursor/plugins/tree/main/cursor-team-kit/skills/fix-ci), MIT license._
