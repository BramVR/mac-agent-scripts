...
const LANES = "Ten lanes in waves up to available capacity on `gpt-5.6-luna` at high reasoning at the PR head";
const SUB_BLOCKS = [
	"Depends on.",
	"Files.",
	"Build.",
...
const PROGRAM_MARKERS = ["/goal", "${CODEX_HOME:-$HOME/.codex}/skills/", /30[- ]minute/, "status message"];
