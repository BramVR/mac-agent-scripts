...
5. **Spawn one blinded judge** in another independent fresh context per the **arena** skill's Phase C. The judge uses `gpt-5.6-sol` at high reasoning and sees outputs by sanitized label and the rubric, never a run label.
