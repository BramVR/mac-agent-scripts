...
- After adding/removing/renaming a skill: run `scripts/sync-skills` (mirrors into `~/.agents/skills` + `~/.claude/skills` + `~/.codex/skills`, prunes dead links). `--dry-run` to preview.
